...
function Carousel() {
  ...
  return (
    <div className="max-w-[1400px] h-[780px] w-full 
                    m-auto py-16 px-4 relative group">
      ...
      <div className="hidden group-hover:block absolute top-[50%] p-2 
                      -translate-x-0 translate-y-[-50%] left-5 text-2xl  
                      rounded-full bg-black/20 text-white cursor-pointer">
