              ...
              <img
                ...
                <div className="p-4">
                 <h3 className="text-xl font-bold text-black mb-2">Slider colcci</h3>
                  ...
                  Slider colcci em varias cores, super confortavel<Counter/> </p>
                <div className="mt-4">
              ...
              <img
                ...
                <div className="p-4">
                 <h3 className="text-xl font-bold text-black mb-2">Vestido Colcci Fitness</h3>
                  <p className="text-zinc-300 font-bold ">
                   Vestidos colcci em varias cores e tecido super leve<Counter/></p>
                <div className="mt-4">
              ...
              <img
                ...
                <div className="p-4">
                 <h3 className="text-xl font-bold text-black mb-2">Bolsa colcci</h3>
                  <p className="text-zinc-300 font-bold">
                   Bolsa colcci em varias cores, para varias ocasioes<Counter/> </p>
                <div className="mt-4">
